REM @english
REM DEFINE PRAGMAS STACK POSITION AND SIZE (3)
REM
...
REM 
REM @italian
REM PRAGMA E DEFINIZIONI POSIZIONE E DIMENSIONE STACK (3)
REM
...
REM programmabile.
REM
REM @include msx1,sc3000,sg1000

OPTION COMPILE ON MSX1,SC3000,SG1000

	DEFINE STACK SIZE 100
	DEFINE STACK START &HC6F0
