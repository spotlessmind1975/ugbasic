REM @english
REM EXTERNAL INTEGRATION SYSTEM CALLS (ON COMMODORE 128)
REM 
REM This small example explains how to invoke Commodore 128 system 
...
REM 
REM @italian
REM INTEGRAZIONE CODICE ESTERNO CHIAMATE DI SISTEMA (SU COMMODORE 128)
REM
REM Questo piccolo esempio spiega come richiamare funzionalità 
REM di sistema del Commodore 128. Si fa presente che questo è 
