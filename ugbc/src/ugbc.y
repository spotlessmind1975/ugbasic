...
%token MID INSTR UPPER LOWER LCASE STR VAL STRING SPACE FLIP CHR ASC LEN MOD ADD MIN MAX SGN
...
%token INKEY SCANCODE SCAN SHIFT SCANSHIFT SHIFTS NONE ASTERISK COLON COMMA 
...
%token EMBEDDED NATIVE RELEASE READONLY OPTION EXPLICIT ORIGIN RELATIVE DTILE DTILES OUT RESOLUTION
