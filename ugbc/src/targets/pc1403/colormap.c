...
void colormap_clear_with( Environment * _environment, int _foreground, int _background ) {
    ...
    sc61860_fill_blocks( _environment, colormapAddress->realName, blocks->realName, value->realName );
...
void colormap_clear_with_vars( Environment * _environment, char * _foreground, char * _background ) {
    ...
    sc61860_fill_blocks( _environment, colormapAddress->realName, blocks->realName, pattern->realName );
