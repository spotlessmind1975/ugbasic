...
Variable * random_value( Environment * _environment, VariableType _type ) {
    ...
    switch( VT_BITWIDTH( _type ) ) {
        case 8:
            sc61860_random_8bit( _environment, "$FC9E", result->realName );
            break;
        case 16:
            sc61860_random_16bit( _environment, "$FC9E", result->realName );
            break;
        case 32:
            sc61860_random_32bit( _environment, "$FC9E", result->realName );
            break;
        default:
