...
void every_ticks_call( Environment * _environment, char * _timing, char * _name, char * _timer ) {
    ...
    d64b_timer_set_address( _environment, timerRealName, procedure->realName );
    d64b_timer_set_counter( _environment, timerRealName, timing->realName );
    d64b_timer_set_init( _environment, timerRealName, timing->realName );
