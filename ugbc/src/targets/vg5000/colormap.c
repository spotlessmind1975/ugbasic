...
void colormap_at( Environment * _environment, int _address ) {
    ...
    // TODO: colormapAddress must be retrieved by a ef9345_get_colormapAddress()
...
void colormap_clear_with( Environment * _environment, int _foreground, int _background ) {
   ...
   cpu_fill_blocks( _environment, colormapAddress->realName, blocks->realName, value->realName );
...
void colormap_clear_with_vars( Environment * _environment, char * _foreground, char * _background ) {
   ...
   cpu_fill_blocks( _environment, colormapAddress->realName, blocks->realName, pattern->realName );
