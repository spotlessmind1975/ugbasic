...
void bell( Environment * _environment, int _note, int _channels ) {
    ...
    sn76489_set_program( _environment, _channels, IMF_INSTRUMENT_GLOCKENSPIEL );
...
void bell_vars( Environment * _environment, char * _note, char * _channels ) {
    ...
    if ( _channels ) {
        ...
        sn76489_set_program_semi_var( _environment, channels->realName, IMF_INSTRUMENT_GLOCKENSPIEL );
        sn76489_set_note_vars( _environment, channels->realName, note->realName );
    } else {
        sn76489_start_var( _environment, NULL );
        sn76489_set_program_semi_var( _environment, NULL, IMF_INSTRUMENT_GLOCKENSPIEL );
