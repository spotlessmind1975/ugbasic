...
void volume_off( Environment * _environment, int _channels ) {
    ...
    sn76489z_set_volume( _environment, 0, _channels );
...
void volume_off_var( Environment * _environment, char * _channels ) {
    ...
    if ( _channels ) {
        ...
        sn76489z_set_volume_semi_var( _environment, channels->realName, 0 );
    } else {
        sn76489z_set_volume_semi_var( _environment, NULL, 0 );
    }
