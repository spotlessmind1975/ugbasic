...
The ''VCENTER'' command aligns a text string in the center of the screen. In other 
...
Il comando ''VCENTER'' allinea una stringa di testo al centro dello schermo. 
In altre parole, consente di posizionare una parola o una frase in modo che 
occupi lo spazio disponibile in modo simmetrico, in verticale. Se l'istruzione 
...
Utilizzando VCENTER, è possibile assicurarsi che il testo sia allineato in modo 
