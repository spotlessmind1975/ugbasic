...
per arrivare alle coordinate ''(x2,y2)'', utilizzando il colore ''c''. Le coordinate di inizio
possono essere omesse: in tal caso, ugBASIC disegnerà 
a partire dall'ultima posizione disegnata. 
