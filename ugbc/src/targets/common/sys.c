...
@syntax SYS address _
@syntax      [ WITH REG(r1)=v1[, REG(r2)=v2 [, ... ] ] ] _
@syntax      [ RETURN x1=REG(r1)[, x2=REG(r2)[, ... ] ] ] _
@syntax      [ ON target1[, target2[, ... ] ] ]
...
@syntax EXEC address _
@syntax      [ WITH REG(r1)=v1[, REG(r2)=v2 [, ... ] ] ] _
@syntax      [ RETURN x1=REG(r1)[, x2=REG(r2)[, ... ] ] ] _
@syntax      [ ON target1[, target2[, ... ] ] ]

@example EXEC #49142
@example EXEC indirizzo
@example EXEC indirizzo WITH REG(A)=42 RETURN y=REG(B) ON CPUZ80
