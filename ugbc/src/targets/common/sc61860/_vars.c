...
void vars_emit_word( Environment * _environment, char * _name, int _value ) {
    if ( _name ) {
        outline3("%s:  .db 0x%2.2x, 0x%2.2x", _name, (unsigned char)(_value&0xff), (unsigned char)((_value>>8)&0xff) );
    } else {
        outline2(" .db 0x%2.2x, 0x%2.2x", (unsigned char)(_value&0xff), (unsigned char)((_value>>8)&0xff) );
    }
}
