...
Variable * travel_path( Environment * _environment, char * _p, char * _x, char * _y, char * _times, char * _limited ) {
    ...
    deploy_begin( travel_path );
        ...
        cpu_move_8bit( _environment, address_displacement( _environment, path->realName, "6" ), dy2->realName );
        ...
        cpu_move_8bit( _environment, address_displacement( _environment, path->realName, "10" ), fraction->realName );
        ...
        cpu_move_8bit( _environment, dy2->realName, address_displacement( _environment, path->realName, "6" ) );
        cpu_move_8bit( _environment, fraction->realName, address_displacement( _environment, path->realName, "10" ) );
