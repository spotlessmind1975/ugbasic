...
the BASIC command ''ON''. Instead of specifying the jump targets as with ''ON''
...
''CGOTO'' without much typing. The use of ''CGOTO'' requires that the lines 
...
dal risultato di un calcolo. ''CGOTO'' è un comando che sostituisce le tabelle 
...
tramite calcolo dopo ''CGOTO'' senza molta digitazione. L'uso di ''CGOTO''
