...
@italian
Il comando ''MOB SHOW'' permette di mostrare (abilitare) un oggetto mobile.

@syntax MOB SHOW [index]

@example MOB SHOW starship
...
void mob_show( Environment * _environment, char * _index ) {
    ...
    cpu_mobshow( _environment, index->realName );
