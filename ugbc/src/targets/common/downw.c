...
/**
 * @brief Emit code for <strong>DOWNW ...</strong>
 * 
...
''DOWNW'' allows the programmer to scroll down a section of the text screen from ''x,y''
with the ''width'' and the ''height'', including the colors, line by line. The new 
lines inserted are filled in the upper line with the correspondent character
that exit from the bottom.
...
''DOWNW'' consente al programmatore di scorrere verso l'alto una sezione dello schermo 
di testo da ''x,y'' con la ''width'' e l''height'', inclusi i colori, riga per riga. 
Le nuove righe inserite vengono riempite nella riga superiore con il carattere che
