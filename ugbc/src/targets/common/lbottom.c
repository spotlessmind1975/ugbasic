...
The ''LBOTTOM'' command moves the text cursor to the bottom left angle
of the screen in a hurry.

@italian

Il comando ''BOTTOM'' riporta il cursore del testo nell'angolo inferiore sinistro'
dello schermo, e in fretta.
