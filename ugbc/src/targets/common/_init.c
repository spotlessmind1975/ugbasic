...
void setup_text_variables( Environment * _environment ) {
    ...
    variable_define( _environment, "SBINK0", VT_COLOR, _environment->defaultPenColor );
    variable_global( _environment, "SBINK0" );
    variable_define( _environment, "SBINK1", VT_COLOR, _environment->defaultPenColor );
    variable_global( _environment, "SBINK1" );
    variable_define( _environment, "SBINK2", VT_COLOR, _environment->defaultPenColor );
    variable_global( _environment, "SBINK2" );
    variable_define( _environment, "SBINK3", VT_COLOR, _environment->defaultPenColor );
...
void finalize_text_variables( Environment * _environment ) {
    ...
    if ( !_environment->deployed.draw_tsb_string && !_environment->deployed.draw_string ) {
