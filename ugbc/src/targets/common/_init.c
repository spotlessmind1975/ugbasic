...
void setup_text_variables( Environment * _environment ) {
    ...
    variable_define( _environment, "DRAWUCOMMAND", VT_BYTE, 'U' );
    variable_global( _environment, "DRAWUCOMMAND" );
    variable_define( _environment, "DRAWDCOMMAND", VT_BYTE, 'D' );
    variable_global( _environment, "DRAWDCOMMAND" );
    variable_define( _environment, "DRAWLCOMMAND", VT_BYTE, 'L' );
    variable_global( _environment, "DRAWLCOMMAND" );
    variable_define( _environment, "DRAWRCOMMAND", VT_BYTE, 'R' );
    variable_global( _environment, "DRAWRCOMMAND" );
    variable_define( _environment, "DRAWECOMMAND", VT_BYTE, 'E' );
    variable_global( _environment, "DRAWECOMMAND" );
    variable_define( _environment, "DRAWFCOMMAND", VT_BYTE, 'F' );
    variable_global( _environment, "DRAWFCOMMAND" );
    variable_define( _environment, "DRAWGCOMMAND", VT_BYTE, 'G' );
    variable_global( _environment, "DRAWGCOMMAND" );
    variable_define( _environment, "DRAWHCOMMAND", VT_BYTE, 'H' );
