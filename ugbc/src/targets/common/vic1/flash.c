...
void flash( Environment * _environment, char * _index, char * _register ) {
    ...
    vic1_flash_begin( _environment, idx->realName, reg!=NULL?reg->realName:NULL );
    ...
    while( i < _environment->flashVarsIndex ) {
        ...
        ++i;
        vic1_flash_register( _environment, idx->realName, timer->realName, color->realName );
    } 

    vic1_flash_end( _environment );
...
void flash_off( Environment * _environment, char * _index ) {
    ...
    vic1_flash_off( _environment, idx->realName );
