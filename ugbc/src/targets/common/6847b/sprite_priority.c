...
#if defined(__cocob__) || defined(__d32b__) || defined(__d64b__)
 ...
 */
void sprite_priority( Environment * _environment, int _sprite, int _color ) {
 ...
 */
void sprite_priority_vars( Environment * _environment, char * _sprite, char * _color ) {
