...
static void variable_cleanup_memory_mapped( Environment * _environment, Variable * _variable ) {
    ...
    switch( _variable->type ) {
        ...
        case VT_COLOR:
        case VT_THREAD:
            vars_emit_byte( _environment, NULL, variable->initialValue);
            break;
        case VT_DOJOKA:
            outline0(" .res 8" );
            break;
        ...
        case VT_POSITION:
        case VT_ADDRESS:
            vars_emit_word( _environment, NULL, variable->initialValue);
            break;
        case VT_DWORD:
        case VT_SDWORD:
            vars_emit_dword( _environment, NULL, variable->initialValue);
            break;
        case VT_FLOAT: {
