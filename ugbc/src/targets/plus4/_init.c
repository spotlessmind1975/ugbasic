...
void target_initialization( Environment * _environment ) {
    ...
    variable_import( _environment, "BITMAPADDRESS", VT_ADDRESS, 0xE000 );
    variable_global( _environment, "BITMAPADDRESS" );
    variable_import( _environment, "COLORMAPADDRESS", VT_ADDRESS, 0xE800 );
    variable_global( _environment, "COLORMAPADDRESS" );
    variable_import( _environment, "TEXTADDRESS", VT_ADDRESS, 0xEC00 );
