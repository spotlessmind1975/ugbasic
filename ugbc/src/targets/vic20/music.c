...
void music_pause( Environment * _environment ) {
    ...
    cpu_store_8bit( _environment, "VIC1MUSICPAUSE", 0xff );
...
void music_resume( Environment * _environment ) {
    ...
    cpu_store_8bit( _environment, "VIC1MUSICPAUSE", 0x0 );
...
void music_stop( Environment * _environment ) {
    ...
    cpu_store_8bit( _environment, "VIC1MUSICLOOP", 0x0 );
    cpu_store_8bit( _environment, "VIC1MUSICREADY", 0x0 );
    volume( _environment, 0, 0x7 );
...
void music_seek_var( Environment * _environment, char * _position ) {
    ...
    cpu_move_8bit( _environment, address_displacement( _environment, position->realName, "1" ), "VIC1BLOCKS" );
    cpu_move_8bit( _environment, position->realName, "VIC1LASTBLOCK" );
