...
void instrument( Environment * _environment, int _instrument, int _channels ) {
    ...
    sidz_set_program( _environment, _channels, _instrument );
...
void instrument_semi_var( Environment * _environment, int _instrument, char * _channels ) {
    ...
    if ( _channels ) {
        ...
        sidz_set_program_semi_var( _environment, channels->realName, _instrument );
    } else {
        sidz_start_var( _environment, NULL );
        sidz_set_program_semi_var( _environment, NULL, _instrument );
    }
