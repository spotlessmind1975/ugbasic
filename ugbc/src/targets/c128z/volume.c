...
void volume( Environment * _environment, int _volume, int _channels ) {
    ...
    sidz_set_volume( _environment, _volume/16, _channels );
...
void volume_vars( Environment * _environment, char * _volume, char * _channels ) {
    ...
    if ( _channels ) {
        ...
        sidz_set_volume_vars( _environment, channels->realName, volume->realName );
    } else {
        sidz_set_volume_vars( _environment, NULL, volume->realName );
    }
