...
CHAR { RETURN(CHAR,1); }
chA { RETURN(CHAR,1); /* C= BASIC V3.5 */ }
CHR { RETURN(CHR,1); }
CHR\$ { RETURN(CHR,1); }
Ch { RETURN(CHR,1); }
cH { RETURN(CHR,1); /* C= BASIC V2.0 */ }
CIRCLE { RETURN(CIRCLE,1); }
Ci { RETURN(CIRCLE,1); }
cI { RETURN(CIRCLE,1); /* C= BASIC V3.5 */ }
...
Cr { RETURN(COLOR,1); }
coL { RETURN(COLOR,1); /* C= BASIC V3.5 */ }
...
Eq { RETURN(EQUAL,1); }
EXIT { RETURN(EXIT,1); }
exI { RETURN(EXIT,1); /* C= BASIC V3.5 */ }
Ex { RETURN(EXIT,1); }
...
GOTO { RETURN(GOTO,1); }
Gt { RETURN(GOTO,1); }
gO { RETURN(GOTO,1); /* C= BASIC V2.0 */ }
GOSUB { RETURN(GOSUB,1); }
Gs { RETURN(GOSUB,1); }
goS { RETURN(GOSUB,1); /* C= BASIC V2.0 */ }
GR { RETURN(GR,1); }
GRAPHIC { RETURN(GRAPHIC,1); }
Gr { RETURN(GRAPHIC,1); }
gR { RETURN(GRAPHIC,1); /* C= BASIC V3.5 */ }
GRAY { RETURN(GRAY,1); }
Gy { RETURN(GRAY,1); }
...
inS { RETURN(INSTR,1); /* C= BASIC V3.5 */ }
Ist { RETURN(INSTR,1); }
IS { RETURN(IS,1); }
J { RETURN(J,1); }
...
JOY { RETURN(JOY,1); }
Jy { RETURN(JOY,1); }
jO { RETURN(JOY,1); /* C= BASIC V3.5 */ }
JOYCOUNT { RETURN(JOYCOUNT,1); }
Jyc { RETURN(JOYCOUNT,1); }
K { RETURN(K,1); }
KEY { RETURN(KEY,1); }
Ky { RETURN(KEY,1); }
kE { RETURN(KEY,1); /* C= BASIC 3.5 */ }
...
Lf { RETURN(LEFT,1); }
LEFT\$ { RETURN(LEFT,1); }
leF { RETURN(LEFT,1); /* C= BASIC V2.0 */ }
LEN { RETURN(LEN,1); }
...
LOAD { RETURN(LOAD,1); }
Ld { RETURN(LOAD,1); }
lO { RETURN(LOAD,1); /* C= BASIC V2.0 */ }
LOCATE { RETURN(LOCATE,1); }
loC { RETURN(LOCATE,1); /* C= BASIC V3.5 */ }
Lc { RETURN(LOCATE,1); }
LOCK { RETURN(LOCK,1); }
Lk { RETURN(LOCK,1); }
LOOP { RETURN(LOOP,1); }
Lp { RETURN(LOOP,1); }
loO { RETURN(LOOP,1); /* C= BASIC V3.5 */ }
...
Rt { RETURN(RETURN,1); }
reT { RETURN(RETURN,1); /* C= BASIC V2.0 */ }
RGB { RETURN(RGB,1); }
RIGHT { RETURN(RIGHT,1); }
RIGHT\$ { RETURN(RIGHT,1); }
Rg { RETURN(RIGHT,1); }
rI { RETURN(RIGHT,1); /* C= BASIC V2.0 */ }
RND { RETURN(RND,1); }
rN { RETURN(RND,1); /* C= BASIC V2.0 */ }
ROLL { RETURN(ROLL,1); }
Rl { RETURN(ROLL,1); }
ROWS { RETURN(ROWS,1); }
Rws { RETURN(ROWS,1); }
...
Spr { RETURN(SPRITE,1); }
SQR { RETURN(SQR,1); }
sQ { RETURN(SQR,1); /* C= BASIC V2.0 */ }
STATE { RETURN(STATE,1); }
Stt { RETURN(STATE,1); }
STEP { RETURN(STEP,1); }
Stp { RETURN(STEP,1); }
stE { RETURN(STEP,1); /* C= BASIC V2.0 */ }
STOP { RETURN(STOP,1); }
St { RETURN(STOP,1); }
sT { RETURN(STOP,1); /* C= BASIC V2.0 */ }
STR { RETURN(STR,1); }
STR\$ { RETURN(STR,1); }
stR { RETURN(STR,1); /* C= BASIC V2.0 */ }
STRING { RETURN(STRING,1); }
STRING\$ { RETURN(STRING,1); }
T { RETURN(T,1); }
TAB { RETURN(TAB,1); }
Tb { RETURN(TAB,1); }
tA { RETURN(TAB,1); /* C= BASIC V2.0 */ }
TAN { RETURN(TAN,1); }
Tn { RETURN(TAN,1); }
TASK { RETURN(TASK,1); }
Ts { RETURN(TASK,1); }
...
Wh { RETURN(WHILE,1); }
wH { RETURN(WHILE,1); /* C= BASIC V3.5 */ }
...
[a-z\_][a-z0-9\_][a-z0-9\_][A-Za-z0-9\_]* { yylval.string = strdup(yytext); RETURN(Identifier,1);  }
[a-z\_][a-z0-9\_] { yylval.string = strdup(yytext); RETURN(Identifier,1);  }
