...
#if defined(__pc128op__) || defined(__coco__) || defined(__coco3__) || defined(__cocob__) || defined(__coco3b__)
...
void sn76489m_music( Environment * _environment, char * _music, int _size, int _loop, int _type, int _bank ) {
    ...
    outline1("LDA #$%2.2x", ( _size>>7 ) & 0xff);
    outline1("LDB #$%2.2x", _size - ( _size>>7 )*256 );
