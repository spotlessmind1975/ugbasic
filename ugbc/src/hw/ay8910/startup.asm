...
AY8910STARTUP:
    ...
    LD (HL), A
    LD E, $8
    CALL AY8910STARTVOL0
    CALL AY8910STARTVOL1
    CALL AY8910STARTVOL2
    RET
...
AY8910STARTVOL:
    SRL A
    JR NC,AY8910STARTVOL0X
    CALL AY8910STARTVOL0
AY8910STARTVOL0X:
    SRL A
    JR NC, AY8910STARTVOL1X
    CALL AY8910STARTVOL1
AY8910STARTVOL1X:
    SRL A
    JR NC, AY8910STARTVOL2X
    CALL AY8910STARTVOL2
AY8910STARTVOL2X:
    SRL A
    JR NC, AY8910STARTVOLN0X
    CALL AY8910STARTVOLN0
AY8910STARTVOLN0X:
    RET
...
AY8910PROGFREQ2X:
    SRL A
    JP NC, AY8910PROGFREQN0X
    CALL AY8910PROGFREQN0
AY8910PROGFREQN0X:
    POP AF
    RET
...
AY8910PROGDUR2X:
    SRL A
    JP NC, AY8910PROGDURN0X
    CALL AY8910PROGDURN0
AY8910PROGDURN0X:
    RET
...
AY8910WAITDUR2X:
    SRL A
    JP NC, AY8910WAITDURN0X
    CALL AY8910WAITDURN0
AY8910WAITDURN0X:
    RET
...
AY8910MANAGER:
    ...
    LD A, E
    OR D
    JR NZ, AY8910MANAGER2D1
    CALL AY8910STOP0
AY8910MANAGER2D1:
    LD DE, (AY8910TIMER+2)
    LD A, E
    OR D
    JR Z, AY8910MANAGER2D2
    LD DE, (AY8910TIMER+2)
    DEC DE
    LD (AY8910TIMER+2), DE    
    LD DE, (AY8910TIMER+2)
    LD A, E
    OR D
    JR NZ, AY8910MANAGER2D2
    CALL AY8910STOP1
AY8910MANAGER2D2:
    LD DE, (AY8910TIMER+4)
    LD A, E
    OR D
    JR Z, AY8910MANAGER2D3
    LD DE, (AY8910TIMER+4)
    DEC DE
    LD (AY8910TIMER+4), DE    
    LD DE, (AY8910TIMER+4)
    LD A, E
    OR D
    JR NZ, AY8910MANAGER2D3
    CALL AY8910STOP2
AY8910MANAGER2D3:
    LD DE, (AY8910TIMER+6)
    LD A, E
    OR D
    JR Z, AY8910MANAGER2DN0
    LD DE, (AY8910TIMER+6)
    DEC DE
    LD (AY8910TIMER+6), DE    
    LD DE, (AY8910TIMER+6)
