...
C6847BVIDEOSTARTAT
    ...
    LDB #$07
    LDX #$FFC6
C6847BVIDEOSTARTATL1
    RORA
    BCC C6847BVIDEOSTARTATB0
    STA 1,X
    BRA C6847BVIDEOSTARTATL1NX
C6847BVIDEOSTARTATB0
    STA ,X
C6847BVIDEOSTARTATL1NX
    LEAX 2,X
    DECB
    BNE C6847BVIDEOSTARTATL1
    RTS
