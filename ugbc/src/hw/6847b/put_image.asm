...
; PUTIMAGE2TRANSL1B
    DECB
    CMPB #0
    LBGE PUTIMAGE2TRANSL1

    LDA <IMAGEF
    ANDA #64
    CMPA #0
    BEQ PUTIMAGE2TRANSL1N

    LDA <IMAGEF
    ANDA #1
    CMPA #1
    BEQ PUTIMAGE2TRANSL1N0
...
PUTIMAGE2TRANSL1N
    ...
    LDB <IMAGEW
    DECB
    JMP PUTIMAGE2TRANSL1

PUTIMAGECOMMONETRANS
    RTS
...
PUTIMAGEOPTIMIZED
    LDA <IMAGEW
    CMPA #1
    LBEQ PUTIMAGEOPTIMIZED1
    CMPA #2
    LBEQ PUTIMAGEOPTIMIZED2
    CMPA #4
    LBEQ PUTIMAGEOPTIMIZED4
