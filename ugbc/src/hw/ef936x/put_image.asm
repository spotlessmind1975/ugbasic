...
@ELSE
    ...
    LDB DOUBLEBUFFERENABLED
    LBEQ PUTIMAGESETCOLORORIG
...
PUTIMAGESETCOLORDB
    ...
    LDB #$27
    STB PUTIMAGE2L1DBSETCOLOR
    STB PUTIMAGE2YDEFDBSETCOLOR
    LDB #$02
    STB PUTIMAGE2L1DBSETCOLOR+1
    LDB #$86
    STB PUTIMAGE2L1DBSETCOLOR+2
    STA PUTIMAGE2L1DBSETCOLOR+3

    LDB #$27
    STB PUTIMAGE2L12DBSETCOLOR
    LDB #$02
    STB PUTIMAGE2L12DBSETCOLOR+1
    LDB #$86
    STB PUTIMAGE2L12DBSETCOLOR+2
    STA PUTIMAGE2L12DBSETCOLOR+3
    RTS
...
PUTIMAGESETCOLORORIG

    LDB #$27
    STB PUTIMAGE2L1SETCOLOR
    LDB #$02
    STB PUTIMAGE2L1SETCOLOR+1
    LDB #$86
    STB PUTIMAGE2L1SETCOLOR+2
    STA PUTIMAGE2L1SETCOLOR+3

    LDB #$27
    STB PUTIMAGE2L12SETCOLOR
    LDB #$02
    STB PUTIMAGE2L12SETCOLOR+1
    LDB #$86
    STB PUTIMAGE2L12SETCOLOR+2
    STA PUTIMAGE2L12SETCOLOR+3
    RTS
...
@ELSE
    ...
    ; whe should use a different version.
    LDB DOUBLEBUFFERENABLED
    LBEQ PUTIMAGECLRCOLORORIG

@ENDIF

@IF !vestigialConfig.doubleBufferSelected || vestigialConfig.doubleBuffer

PUTIMAGECLRCOLORORIGDB

    LDB #$26
    STB PUTIMAGE2YDEFDBSETCOLOR
    LDX #PUTIMAGE2L1DBSETCOLOR
    LDD #$1212
    STD ,X++
    STD ,X++
    LDX #PUTIMAGE2L12DBSETCOLOR
    LDD #$1212
    STD ,X++
    STD ,X++
    RTS
...
PUTIMAGECLRCOLORORIG

    LDX #PUTIMAGE2L1SETCOLOR
    LDD #$1212
    STD ,X++
    STD ,X++
    LDX #PUTIMAGE2L12SETCOLOR
    LDD #$1212
    STD ,X++
    STD ,X++
    RTS
...
@IF transparencyCoarse
    LDA <(IMAGEW+1)
    CMPA #1
    LBEQ PUTIMAGE2YTRANS3DBEVEN1
    CMPA #2
    LBEQ PUTIMAGE2YTRANS3DBEVEN2
    CMPA #4
    LBEQ PUTIMAGE2YTRANS3DBEVEN4
@ENDIF
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;; OPTIMIZED COARSE TRANSPARENCY w=1,2 or 4
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

PUTIMAGE2YTRANS3DBEVEN1
...
PUTIMAGE2YTRANS3DBEVEN1L1
    LDA ,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN1L10
    STA ,X
PUTIMAGE2YTRANS3DBEVEN1L10
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN1L1D

    BRA PUTIMAGE2YTRANS3DBEVEN1L1

PUTIMAGE2YTRANS3DBEVEN1L1D
...
PUTIMAGE2YTRANS3DBEVEN1L2
    CLRB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN1L20
    STA B,X
PUTIMAGE2YTRANS3DBEVEN1L20
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN1L2D

    CLRB
    BRA PUTIMAGE2YTRANS3DBEVEN1L2

PUTIMAGE2YTRANS3DBEVEN1L2D

    JMP PUTIMAGECOMMONEDB

PUTIMAGE2YTRANS3DBEVEN2
...
PUTIMAGE2YTRANS3DBEVEN2L1
    CLRB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN2L10
    STA B,X
PUTIMAGE2YTRANS3DBEVEN2L10
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN2L11
    STA B,X
PUTIMAGE2YTRANS3DBEVEN2L11
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN2L1D

    CLRB
    BRA PUTIMAGE2YTRANS3DBEVEN2L1

PUTIMAGE2YTRANS3DBEVEN2L1D
...
PUTIMAGE2YTRANS3DBEVEN2L2
    CLRB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN2L20
    STA B,X
PUTIMAGE2YTRANS3DBEVEN2L20
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN2L21
    STA B,X
PUTIMAGE2YTRANS3DBEVEN2L21
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN2L2D

    CLRB
    BRA PUTIMAGE2YTRANS3DBEVEN2L2

PUTIMAGE2YTRANS3DBEVEN2L2D

    JMP PUTIMAGECOMMONEDB

PUTIMAGE2YTRANS3DBEVEN4
...
PUTIMAGE2YTRANS3DBEVEN4L1
    CLRB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L10
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L10
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L11
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L11
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L12
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L12
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L13
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L13
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN4L1D

    CLRB
    BRA PUTIMAGE2YTRANS3DBEVEN4L1

PUTIMAGE2YTRANS3DBEVEN4L1D
...
PUTIMAGE2YTRANS3DBEVEN4L2
    CLRB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L20
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L20
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L21
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L21
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L22
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L22
    INCB
    LDA B,Y
    BEQ PUTIMAGE2YTRANS3DBEVEN4L23
    STA B,X
PUTIMAGE2YTRANS3DBEVEN4L23
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGE2YTRANS3DBEVEN4L2D

    CLRB
    BRA PUTIMAGE2YTRANS3DBEVEN4L2
...
PUTIMAGE2YDEFDB
    LDA <IMAGEF
    ANDA #64
PUTIMAGE2YDEFDBSETCOLOR
    BEQ PUTIMAGE2YDEFDBL128
...
PUTIMAGE2YDEFDBW128EVEN1
    ...
    LDA #CURRENTSL
    DECA
    STA PUTIMAGE2L1DBNW128EVEN1DELTA0+2
    STA PUTIMAGE2L1DBNW128EVEN1DELTA1+2
...
PUTIMAGE2L1DBNW128EVEN1DELTA1
    LEAX 42, X

    DEC <IMAGEH
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGECOMMONE5DBW128EVEN1

    BRA PUTIMAGE2L12DB000W128EVEN1
...
PUTIMAGE2YDEFDBW128EVEN2
    ...
    DECA
    DECA
    STA PUTIMAGE2L1DBNW128EVEN2DELTA0+2
    STA PUTIMAGE2L1DBNW128EVEN2DELTA1+2
...
PUTIMAGE2L1DBNW128EVEN2DELTA0
    LEAX 42, X

    DEC <IMAGEH
    LDB <IMAGEH
    CMPB #0
    BNE PUTIMAGE2L1DB000W128EVEN2
...
PUTIMAGE2L1DBNW128EVEN2DELTA1
    LEAX 42, X

    DEC <IMAGEH
    LDB <IMAGEH
    CMPB #0
    BNE PUTIMAGE2L12DB000W128EVEN2
...
PUTIMAGE2YDEFDBW128EVEN3EVEN

    LDA #CURRENTSL
    DECA
    DECA
    DECA
    STA PUTIMAGE2YDEFDBW128EVEN3EVENDELTA0+2
    STA PUTIMAGE2YDEFDBW128EVEN3EVENDELTA1+2
    STA PUTIMAGE2YDEFDBW128EVEN3EVENDELTA2+2
    STA PUTIMAGE2YDEFDBW128EVEN3EVENDELTA3+2
...
PUTIMAGE2YDEFDBW128EVEN3EVEN3
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+
PUTIMAGE2YDEFDBW128EVEN3EVENDELTA0
    LEAX 42, X
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+
PUTIMAGE2YDEFDBW128EVEN3EVENDELTA1
    LEAX 42, X
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGECOMMONE2DBW128EVEN3EVEN3

    JMP PUTIMAGE2YDEFDBW128EVEN3EVEN3

PUTIMAGECOMMONE2DBW128EVEN3EVEN3
...
PUTIMAGE2L12DB000W128EVEN3EVEN3
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+
PUTIMAGE2YDEFDBW128EVEN3EVENDELTA2
    LEAX 42, X
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+
PUTIMAGE2YDEFDBW128EVEN3EVENDELTA3
    LEAX 42, X
    ...
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGECOMMONEDBW128EVEN3EVEN

    JMP PUTIMAGE2L12DB000W128EVEN3EVEN3

PUTIMAGECOMMONE5DBW128EVEN3EVEN
PUTIMAGECOMMONEDBW128EVEN3EVEN
...
PUTIMAGE2YDEFDBW128EVEN3
    
    LSRA
    BCC PUTIMAGE2YDEFDBW128EVEN3EVEN

    LDA #CURRENTSL
    DECA
    DECA
    DECA
    STA PUTIMAGE2L1DBNW128EVEN3DELTA0+2
    STA PUTIMAGE2L1DBNW128EVEN3DELTA1+2
    LDA <IMAGEH
...
PUTIMAGE2L1DB000W128EVEN3
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+

PUTIMAGE2L1DBNW128EVEN3DELTA0
    LEAX 42, X

    DEC <IMAGEH
    LDB <IMAGEH
    CMPB #0
    BEQ PUTIMAGECOMMONE2DBW128EVEN3

    JMP PUTIMAGE2L1DB000W128EVEN3

PUTIMAGECOMMONE2DBW128EVEN3
...
PUTIMAGE2L12DB000W128EVEN3
    LDD ,Y++
    STD ,X++
    LDA ,Y+
    STA ,X+
    
PUTIMAGE2L1DBNW128EVEN3DELTA1
    LEAX 42, X

    DEC <IMAGEH
    LDB <IMAGEH
    CMPB #0
    LBEQ PUTIMAGECOMMONE5DBW128EVEN3

    JMP PUTIMAGE2L12DB000W128EVEN3

PUTIMAGECOMMONE5DBW128EVEN3
PUTIMAGECOMMONEDBW128EVEN3
...
PUTIMAGE2YDEFDBW128EVEN4
    ...
    DECA
    DECA
    STA PUTIMAGE2L1DBNW128EVEN4DELTA0+2
    STA PUTIMAGE2L1DBNW128EVEN4DELTA1+2
    STA <MATHPTR0
...
@ENDIF
    ...
    CMPA #8
    BEQ PUTIMAGE2L1DB000W128EVEN4H8
    CMPA #4
...
@ENDIF
    ...
    LDA <IMAGEH
    CMPA #8
    BEQ PUTIMAGE2L1DB000W128EVEN4H8A
    CMPA #4
