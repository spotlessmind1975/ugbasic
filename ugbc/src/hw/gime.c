...
int gime_screen_mode_enable( Environment * _environment, ScreenMode * _screen_mode ) {
    ...
    switch( _environment->screenColors ) {
        case 2:
            cpu_store_8bit( _environment, "CONSOLEWB", _environment->screenTilesWidth );
            break;
        case 4:
            cpu_store_8bit( _environment, "CONSOLEWB", _environment->screenTilesWidth * 2 );
            break;
        case 16:
            cpu_store_8bit( _environment, "CONSOLEWB", _environment->screenTilesWidth * 4 );
            break;
    }
