...
;  *****************************************************************************
;  * Copyright 2026 Marco Spedaletti (asimov@mclink.it)
...
FPSINGLETO8U:
	...
	ADC A, A
	CCF
	JR NC, FPSINGLETO8U_RETURN_CARRY
	OR A
	JR Z, FPSINGLETO8U_RETURN_CARRY
	INC A
	JR Z, FPSINGLETO8U_INFNAN

	ADD A, 256-135
	JR C, FPSINGLETO8U_RETURN_CARRY
	ADD A, 7
	JR NC, FPSINGLETO8U_RETURN_CARRY
