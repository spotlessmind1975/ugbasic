...
void trs80_color_border( Environment * _environment, char * _color ) {
...
void trs80_vscroll( Environment * _environment, int _displacement ) {
...
void trs80_inkey( Environment * _environment, char * _pressed, char * _key ) {
...
void trs80_scancode( Environment * _environment, char * _pressed, char * _scancode ) {
...
void trs80_scanshift( Environment * _environment, char * _shifts ) {
...
void trs80_keyshift( Environment * _environment, char * _shifts ) {
...
void trs80_clear_key( Environment * _environment ) {

}

void trs80_initialization( Environment * _environment ) {
...
int trs80_screen_mode_enable( Environment * _environment, ScreenMode * _screen_mode ) {
    
}

void trs80_bitmap_enable( Environment * _environment, int _width, int _height, int _colors ) {

}

void trs80_tilemap_enable( Environment * _environment, int _width, int _height, int _colors ) {
...
static Variable * trs80_image_converter_bitmap_mode_standard( Environment * _environment, char * _source, int _width, int _height ) {
...
Variable * trs80_image_converter( Environment * _environment, char * _data, int _width, int _height, int _mode ) {

    switch( _mode ) {

        case BITMAP_MODE_STANDARD:

            return trs80_image_converter_bitmap_mode_standard( _environment, _data, _width, _height );
