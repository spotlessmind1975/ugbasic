...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
;*                                                                             *
;*                      INTERNAL VARIABLES FOR VIC20 TARGET                    *
;*                                                                             *
;*                             by Marco Spedaletti                             *
;*                                                                             *
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *

TEXTADDRESS:        .WORD   $1000
BITMAPADDRESS:      .WORD   $1000
COLORMAPADDRESS:    .WORD   $9400
CURRENTMODE:    .BYTE   0
...
COPYOFTEXTADDRESS = $26 ; $27
COPYOFBITMAPADDRESS = $26 ; $27
