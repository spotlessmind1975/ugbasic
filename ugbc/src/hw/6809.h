...
#define cpu_store_8bit_indirect( _environment, _source, _value ) cpu6809_store_8bit_indirect( _environment, _source, _value )
...
#define cpu_mem_move_direct_with_offset_size( _environment, _source, _offset, _destination, _size ) cpu6809_mem_move_direct_with_offset_size( _environment, _source, _offset, _destination, _size )
...
#define cpu_mem_move_displacement( _environment, _source, _destination, _displacement, _size ) cpu6809_mem_move_displacement( _environment, _source, _destination, _displacement, _size )
...
#define cpu_convert_upto_24bit_bcd( _environment, _source, _dest, _bits ) cpu6809_convert_upto_24bit_bcd( _environment, _source, _dest, _bits )
#define cpu_convert_bcd_to_digits( _environment, _source, _dest ) cpu6809_convert_bcd_to_digits( _environment, _source, _dest )
...
#define cpu_store_8bit_indirect_with_offset( _environment, _source, _value, _offset ) cpu6809_store_8bit_indirect_with_offset( _environment, _source, _value, _offset )
...
#define cpu_bit_check_extended( _environment, _value, _position, _result ) cpu6809_bit_check_extended( _environment, _value, _position, _result )
