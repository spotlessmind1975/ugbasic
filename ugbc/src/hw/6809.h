...
void cpu6809_math_div2_const_16bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
void cpu6809_math_div2_const_32bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
void cpu6809_math_div2_const_8bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
...
void cpu6809_poke_const( Environment * _environment, char * _address, int _value );
...
void cpu6809_pokew_const( Environment * _environment, char * _address, int _value );
...
void cpu6809_poked_const( Environment * _environment, char * _address, int _value );
...
#define cpu_dec_32bit( _environment, _variable ) cpu6809_dec_32bit( _environment, _variable );
...
#define cpu_math_div2_const_16bit( _environment, _source, _value, _signed, _remainder  ) cpu6809_math_div2_const_16bit( _environment, _source, _value, _signed, _remainder  )
#define cpu_math_div2_const_32bit( _environment, _source, _value, _signed, _remainder  ) cpu6809_math_div2_const_32bit( _environment, _source, _value, _signed, _remainder  )
#define cpu_math_div2_const_8bit( _environment, _source, _value, _signed, _remainder   ) cpu6809_math_div2_const_8bit( _environment, _source, _value, _signed, _remainder  )
...
#define cpu_poke_const( _environment,  _address,  _value  ) cpu6809_poke_const( _environment,  _address,  _value  )
...
#define cpu_pokew_const( _environment,  _address,  _value  ) cpu6809_pokew_const( _environment,  _address,  _value  )
...
#define cpu_poked_const( _environment,  _address,  _value  ) cpu6809_poked_const( _environment,  _address,  _value  )
...
#define cpu_protothread_get_address( _environment, _index, _address ) cpu6809_protothread_get_address( _environment, _index, _address )
