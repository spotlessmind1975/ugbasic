...
;     AND $08
;     CP $00
;     JR Z, VZ200PALETTEPRESERVECHECKLOWER

; VZ200PALETTEPRESERVECHECKHIGHER:
;     LD A, (PALETTEPRESERVE+1)
;     AND B
;     JR VZ200PALETTEPRESERVECHECKFINAL
;     PUSH AF
;     LD A, (PALETTEPRESERVE+1)
;     OR B
...
; VZ200PALETTEPRESERVECHECKLOWER:
...
; VZ200PALETTEPRESERVECHECKFINAL:
...
;     ; INC C
;     ; INC HL
; VZ200LOOKFORPALETTEL1:
;     LD A, (HL)
;     CP B
;     JR Z, VZ200LOOKFORPALETTEFOUND
;     INC HL
;     INC C
;     LD A, (PALETTELIMIT)
;     LD E, A
;     LD A, C
;     CP E
;     JR C, VZ200LOOKFORPALETTEL1
;     JR NZ, VZ200LOOKFORPALETTEL1
;     LD A, $FF
;     LD C, A
; VZ200LOOKFORPALETTEFOUND:
;     POP DE
;     POP AF
;     POP HL
;     LD A, C
;     CALL VZ200PALETTESETUSED
;     LD IXH, A
;     POP BC
;     RET

; VZ200PALETTEFINDUNUSED:
;     LD A, (PALETTEUSED)
;     LD B, A
;     LD A, 0
; VZ200PALETTEFINDUNUSEDL1:
;     SRL B
;     JR NC, VZ200PALETTEFINDUNUSEDDONE
;     INC A
;     CMP 8
;     JR NZ, VZ200PALETTEFINDUNUSEDL1
;     LD A, (PALETTEUSED+1)
;     LD B, A
;     LD A, 8
; VZ200PALETTEFINDUNUSEDL2:
;     SRL B
;     JR NC, VZ200PALETTEFINDUNUSEDDONE
;     INC A
;     CMP 16
;     JR NZ, VZ200PALETTEFINDUNUSEDL2
;     LD A, $FF
; VZ200PALETTEFINDUNUSEDDONE:
;     RET
...
;     LD C, 1
;     CP 0
;     JR Z, VZ200PALETTESETUSEDDONE
; VZ200PALETTESETUSEDL1:
;     SLA C
;     DEC A
;     JR NZ, VZ200PALETTESETUSEDL1
; VZ200PALETTESETUSEDDONE:
;     LD A, (PALETTEUSED)
;     OR C
;     LD (PALETTEUSED), A
;     POP BC
...
;     LD C, 1
;     CP 0
;     JR Z, VZ200PALETTESETUSEDDONE8
; VZ200PALETTESETUSEDL2:
;     SLA C
;     DEC A
;     JR NZ, VZ200PALETTESETUSEDL2
; VZ200PALETTESETUSEDDONE8:
;     LD A, (PALETTEUSED+1)
;     OR C
;     LD (PALETTEUSED+1), A
;     POP BC
...
;     LD A, IXL
;     CP $FF
;     JR Z, VZ200INSERTPALETTEDONE
;     ; LD A, (PALETTELIMIT)
;     ; LD B, A
;     ; LD A, (PALETTEUNUSED)
;     ; INC A
;     ; CP B
;     ; JR C, VZ200INSERTPALETTEUNDER
;     ; LD A, 1
;     CALL VZ200PALETTEFINDUNUSED
;     CP $FF
;     JR Z, VZ200INSERTPALETTEDONE
; VZ200INSERTPALETTEUNDER:
;     CALL VZ200PALETTESETUSED
;     ; LD (PALETTEUNUSED), A
;     LD IXH, A
;     ; LD A, (PALETTEUNUSED)
...
; @IF vestigialConfig.palettePreserve
;     CALL VZ200PALETTEPRESERVECHECK
;     CP $0
;     JR NZ, VZ200INSERTPALETTEDONE
; @ENDIF
;     CALL SETHWPALETTE

; VZ200INSERTPALETTEDONE:
;     POP AF
;     POP DE
;     POP HL
;     POP BC
...
;     CALL VZ200PALETTEPRESERVECHECK
;     CP $0
;     JR NZ, VZ200UPDATEPALETTEDONE
; @ENDIF
;     CALL SETHWPALETTE

; VZ200UPDATEPALETTEDONE:
...
; ;           IXH = index of ink
; VZ200SELECTPALETTE:
;     CALL VZ200LOOKFORPALETTE
;     LD A, IXH
;     CP $FF
;     RET NZ
;     CALL VZ200INSERTPALETTE
;     RET
...
; ; VZ200VIDEOMUL8L1:
; ;     ADD HL, HL
; ;     JR NC, VZ200VIDEOMUL8L1A
; ;     ADD HL, DE
; ; VZ200VIDEOMUL8L1A:
; ;     DJNZ VZ200VIDEOMUL8L1
; ;     LD A, L
; ;     POP BC
; ;     POP DE
; ;     POP HL
