#ifndef __UGBC_6847B__
#define __UGBC_6847B__
...
void c6847b_put_image( Environment * _environment, Resource * _image, char * _x, char * _y, char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _flags );
...
void c6847b_put_tile( Environment * _environment, char * _image, char * _x, char * _y );
void c6847b_put_tiles( Environment * _environment, char * _image, char * _x, char * _y, char *_w, char *_h );
void c6847b_move_tiles( Environment * _environment, char * _image, char * _x, char * _y );
