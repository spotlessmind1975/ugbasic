...
; CPURANDOM16:
;     INC CPURANDOM_SEED+2 
;     DEC CPURANDOM_SEED+3 
;     BNE CPURANDOM16B
;     LDA CPURANDOM_ENTROPY
;     STA CPURANDOM_SEED+2 
;     STA CPURANDOM_SEED+3
; CPURANDOM16B:
;     ASL CPURANDOM_SEED
...
;     BCC CPURANDOM162
;     LDA CPURANDOM_SEED
;     EOR CPURANDOM_SEED+2
;     STA CPURANDOM_SEED
;     LDA CPURANDOM_SEED+1
;     EOR CPURANDOM_SEED+3
;     STA CPURANDOM_SEED+1
; CPURANDOM162:
;     RTS
...
CPURANDOM16:
    ...
    STA CPURANDOM_SEED+2
    EOR #$C1
    DEC CPURANDOM_SEED+2
    STA CPURANDOM_SEED+3
CPURANDOM16B:
    LDA CPURANDOM_SEED+2
    LSR
    ROL CPURANDOM_SEED+1
    BCS CPURANDOM16NOEOR
    EOR #$B4
CPURANDOM16NOEOR:
    STA CPURANDOM_SEED+2
    EOR CPURANDOM_SEED+1
    STA CPURANDOM_SEED
    RTS
