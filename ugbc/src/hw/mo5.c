...
static Variable * mo5_image_converter_bitmap_mode_standard( Environment * _environment, char * _source, int _width, int _height ) {
...
Variable * mo5_image_converter( Environment * _environment, char * _data, int _width, int _height, int _mode ) {

}

void mo5_put_image( Environment * _environment, char * _image, char * _x, char * _y ) {
