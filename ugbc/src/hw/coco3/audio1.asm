...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
;*                                                                             *
;*                     1 BIT AUDIO SUPPORT FOR TRS-80 COCO3 3                   *
;*                                                                             *
;*                             by Marco Spedaletti                             *
;*                                                                             *
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *

COCO3AUDIO1FREQTABLE
...
COCO3AUDIO1BELLBITON
    ...
    LDX	TONE
COCO3AUDIO1BELLLOOPON
    LEAY -1, Y
    BEQ COCO3AUDIOBELLEND
    LEAX -1, X
    BNE	COCO3AUDIO1BELLLOOPON

    ; SO NOT WE'VE PLAYED THE NOISE FOR A WHILE LET'S CREATE AN EQUAL SILENCE

COCO3AUDIO1BELLBITOFF
    LDA	PIA1BD
    ANDA #%11111101
    STA	PIA1BD
    ...
    LDX	TONE
COCO3AUDIO1BELLLOOPOFF
    LEAY -1, Y
    BEQ COCO3AUDIOBELLEND
    LEAX -1,X
    BNE	COCO3AUDIO1BELLLOOPOFF
...
COCO3AUDIO1BOOMBITON
    ...
    LDX	TONE
COCO3AUDIO1BOOMLOOPON
    LEAY -1, Y
    BEQ COCO3AUDIO1BOOMEND
    LEAX -1, X
    BNE	COCO3AUDIO1BOOMLOOPON
...
COCO3AUDIO1BOOMBITOFF
    ...
    LDX	TONE
COCO3AUDIO1BOOMLOOPOFF
    LEAY -1, Y
    BEQ COCO3AUDIO1BOOMEND
    LEAX -1,X
    BNE	COCO3AUDIO1BOOMLOOPOFF
