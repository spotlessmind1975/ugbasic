...
PUTIMAGECOMMONCTX:
    ...
    LDA IMAGEF
    AND #64
    BEQ PUTIMAGECOMMONCTXSNG
    JMP PUTIMAGECOMMONCTXDBL

PUTIMAGECOMMONCTXSNG:

    LDA #$4C
    STA PUTIMAGE3L1P1DBL
    LDA #<PUTIMAGECOMMONCL1N0TED
    STA PUTIMAGE3L1P1DBL+1
    LDA #>PUTIMAGECOMMONCL1N0TED
    STA PUTIMAGE3L1P1DBL+2

    JMP PUTIMAGECOMMONCTX2

PUTIMAGECOMMONCTXDBL:
...
PUTIMAGECOMMONCTX2LARGERX:
    ...
    ; SBC IMAGEW
    CMP CURRENTWIDTH
    BEQ PUTIMAGECOMMONCEX
    BCC PUTIMAGECOMMONCEX
...
PUTIMAGECOMMONCEX:
    ...
    ASL IMAGEW
    CMP IMAGEW
    BCS PUTIMAGECOMMONCTX2LARGER
    CMP #$0
    BEQ PUTIMAGECOMMONCTX2LARGER
    ; STA IMAGEW
PUTIMAGECOMMONCTX2LARGER:
    LSR IMAGEW
    LSR IMAGEW
    LSR IMAGEW
    BNE PUTIMAGECOMMONCETX2
...
PUTIMAGECOMMONCT2LARGERX:
    ...
    ; SBC IMAGEW
    CMP CURRENTWIDTH
    BEQ PUTIMAGECOMMONCETX
    BCC PUTIMAGECOMMONCETX
    JMP PUTIMAGECOMMONCET
PUTIMAGECOMMONCETX:
    ASL IMAGEW
    ASL IMAGEW
    ASL IMAGEW
    CMP IMAGEW
    BCC PUTIMAGECOMMONCT2LARGER
    CMP #$0
    BEQ PUTIMAGECOMMONCT2LARGER
    ; STA IMAGEW
PUTIMAGECOMMONCT2LARGER:
    LSR IMAGEW
    LSR IMAGEW
    LSR IMAGEW
    BNE PUTIMAGECOMMONCET2
    JMP PUTIMAGECOMMONCET
PUTIMAGECOMMONCET2:
