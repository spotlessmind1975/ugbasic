...
/**
 * @brief <i>vtech</i>: emit code to check for collision
 * 
 ...
 */
Variable * vtech_collision( Environment * _environment, char * _sprite ) {
 ...
 * @param _result Where to store the result
 */
void vtech_hit( Environment * _environment, char * _sprite_mask, char * _result ) {

}

/**
 * @brief <i>vtech</i>: emit code to change border color
 * 
 ...
 */
void vtech_border_color( Environment * _environment, char * _border_color ) {
...
/**
 * @brief <i>vtech</i>: emit code to change background color
 * 
 * This function can be used to issue code aimed at changing the
 ...
 */
void vtech_background_color( Environment * _environment, int _index, int _background_color ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    ...
    outline0("LD A, 1");
    outline0("LD IYL, A");
    outline0("CALL VTECHUPDATEPALETTE");
 ...
 * @param _background_color Background color to use
 */
void vtech_background_color_vars( Environment * _environment, char * _index, char * _background_color ) {
 ...
 * @param _background_color Background color to use
 */
void vtech_background_color_semivars( Environment * _environment, int _index, char * _background_color ) {
...
/**
 * @brief <i>vtech</i>: emit code to retrieve background color
 * 
 ...
 * @param _background_color Background color to use
 */
void vtech_background_color_get_vars( Environment * _environment, char * _index, char * _background_color ) {
...
/**
 * @brief <i>vtech</i>: emit code to change common sprite's color 
 * 
 * This function can be used to issue code aimed at changing the
 ...
 */
void vtech_sprite_common_color( Environment * _environment, char * _index, char * _common_color ) {

}

/**
 * @brief <i>vtech</i>: emit code to set raster irq
 * 
 ...
 */
void vtech_raster_at( Environment * _environment, char * _label, char * _positionlo, char * _positionhi ) {

}

/**
 * @brief <i>vtech</i>: emit code to wait for next raster irq
 * 
 ...
 *
 */
void vtech_next_raster( Environment * _environment ) {

}

/**
 * @brief <i>vtech</i>: emit code to wait for next raster irq at different position
 * 
 * This function outputs assembly code needed to wait for the
 ...
 * @param _positionhi The vertical position to wait for (bit 8)
 */
void vtech_next_raster_at( Environment * _environment, char * _label, char * _positionlo, char * _positionhi ) {
...
int vtech_screen_mode_enable( Environment * _environment, ScreenMode * _screen_mode ) {
...
void vtech_bitmap_enable( Environment * _environment, int _width, int _height, int _colors ) {
...
void vtech_bitmap_disable( Environment * _environment ) {

}

void vtech_tilemap_enable( Environment * _environment, int _width, int _height, int _colors, int _tile_width, int _tile_height ) {
    ...
    if ( mode ) {
        ...
        // printf("vtech_tilemap_enable() -> -1\n" );
        WARNING_SCREEN_MODE( -1 );
    }

}

void vtech_bitmap_at( Environment * _environment, char * _address ) {

}

void vtech_colormap_at( Environment * _environment, char * _address ) {

}

void vtech_textmap_at( Environment * _environment, char * _address ) {

}

void vtech_pset_int( Environment * _environment, int _x, int _y, int *_c ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( plot, src_hw_vtech_plot_asm );
...
void vtech_pset_vars( Environment * _environment, char *_x, char *_y, char *_c ) {
...
void vtech_pget_color_vars( Environment * _environment, char *_x, char *_y, char * _result ) {
...
void vtech_screen_on( Environment * _environment ) {

}

void vtech_screen_off( Environment * _environment ) {

}

void vtech_screen_rows( Environment * _environment, char * _rows ) {

}

void vtech_screen_columns( Environment * _environment, char * _columns ) {

}

void vtech_sprite_data_from( Environment * _environment, char * _sprite, char * _address ) {

}

void vtech_sprite_data_set( Environment * _environment, char * _sprite, char * _address ) {

}

void vtech_sprite_enable( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_disable( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_at( Environment * _environment, char * _sprite, char * _x, char * _y ) {

}

void vtech_sprite_expand_vertical( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_expand_horizontal( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_compress_vertical( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_compress_horizontal( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_multicolor( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_monocolor( Environment * _environment, char * _sprite ) {

}

void vtech_sprite_color( Environment * _environment, char * _sprite, char * _color ) {

}

void vtech_sprite_priority( Environment * _environment, char * _sprite, char * _priority ) {

}

void vtech_tiles_at( Environment * _environment, char * _address ) {

}

void vtech_vertical_scroll( Environment * _environment, char * _displacement ) {

}

void vtech_horizontal_scroll( Environment * _environment, char * _displacement ) {
...
void vtech_get_width( Environment * _environment, char *_result ) {
...
void vtech_tiles_get( Environment * _environment, char *_result ) {
...
void vtech_get_height( Environment * _environment, char *_result ) {
...
void vtech_cls( Environment * _environment ) {
    
    deploy( clsGraphic, src_hw_vtech_cls_graphic_asm );
    outline0("CALL CLSG");

}

void vtech_scroll_text( Environment * _environment, int _direction, int _overlap ) {

    if ( _direction > 0 ) {
        deploy_preferred( vScrollTextDown, src_hw_vtech_vscroll_text_down_asm );
        outline1("LD IYL, $%2.2x", (unsigned char)(_overlap&0xff) );
        outline0("CALL VSCROLLTDOWN");
    } else {
        deploy_preferred( vScrollTextUp, src_hw_vtech_vscroll_text_up_asm );
        outline1("LD IYL, $%2.2x", (unsigned char)(_overlap&0xff) );
...
void vtech_text( Environment * _environment, char * _text, char * _text_size, int _raw ) {
    ...
    deploy( clsGraphic, src_hw_vtech_cls_graphic_asm );
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    // deploy( textEncodedAt, src_hw_vtech_text_at_asm );
    deploy( textEncodedAtGraphic, src_hw_vtech_text_at_graphic_asm );
...
void vtech_initialization( Environment * _environment ) {
    ...
    outline0("CALL VTECHVIDEOSTARTUP");
    ...
    vtech_screen_mode_enable( _environment, find_screen_mode_by_id( _environment, BITMAP_MODE_DEFAULT ) );
...
void vtech_hscroll_line( Environment * _environment, int _direction, int _overlap ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( textHScrollLine, src_hw_vtech_hscroll_line_asm );
...
void vtech_hscroll_screen( Environment * _environment, int _direction, int _overlap ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( textHScrollScreen, src_hw_vtech_hscroll_screen_asm );
...
void vtech_back( Environment * _environment ) {

}

void vtech_cline( Environment * _environment, char * _characters ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( textCline, src_hw_vtech_cline_asm );
...
int vtech_image_size( Environment * _environment, int _width, int _height, int _mode ) {
...
static Variable * vtech_image_converter_bitmap_mode_hires( Environment * _environment, char * _source, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _transparent_color, int _flags ) {
    ...
    int bufferSize = vtech_image_size( _environment, _frame_width, _frame_height, BITMAP_MODE_GRAPHIC2 );
...
static Variable * vtech_image_converter_multicolor_mode_midres( Environment * _environment, char * _source, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _transparent_color, int _flags ) {
    ...
    int bufferSize = vtech_image_size( _environment, _frame_width, _frame_height, BITMAP_MODE_GRAPHIC1 );
...
static Variable * vtech_image_converter_multicolor_mode_lores( Environment * _environment, char * _source, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _transparent_color, int _flags ) {
    ...
    int bufferSize = vtech_image_size( _environment, _frame_width, _frame_height, BITMAP_MODE_GRAPHIC0 );
...
Variable * vtech_image_converter( Environment * _environment, char * _data, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _mode, int _transparent_color, int _flags ) {
    ...
    switch( _mode ) {
        ...
        case BITMAP_MODE_GRAPHIC2:
            ...
            return vtech_image_converter_bitmap_mode_hires( _environment, _data, _width, _height, _depth, _offset_x, _offset_y, _frame_width, _frame_height, _transparent_color, _flags );
            
        case BITMAP_MODE_GRAPHIC1:

            return vtech_image_converter_multicolor_mode_midres( _environment, _data, _width, _height, _depth, _offset_x, _offset_y, _frame_width, _frame_height, _transparent_color, _flags );

        case BITMAP_MODE_GRAPHIC0:
        case BITMAP_MODE_GRAPHIC3:

            return vtech_image_converter_multicolor_mode_lores( _environment, _data, _width, _height, _depth, _offset_x, _offset_y, _frame_width, _frame_height, _transparent_color, _flags );

    }

    return vtech_new_image( _environment, 8, 8, _mode );

}

static void vtech_load_image_address_to_hl( Environment * _environment, char * _source, char * _sequence, char * _frame, int _frame_size, int _frame_count ) {
...
static void vtech_load_image_address_to_register( Environment * _environment, char * _register, Resource * _source, char * _sequence, char * _frame, int _frame_size, int _frame_count ) {
...
void vtech_put_image( Environment * _environment, Resource * _image, char * _x, char * _y, char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _flags ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( putimage, src_hw_vtech_put_image_asm );

    MAKE_LABEL

    if ( _frame_size ) {
        vtech_load_image_address_to_register( _environment, NULL, _image, _sequence, _frame, _frame_size, _frame_count );
    }
...
void vtech_blit_image( Environment * _environment, char * _sources[], int _source_count, char * _blit, char * _x, char * _y, char * _frame, char * _sequence, int _frame_size, int _frame_count, int _flags ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( blitimage, src_hw_vtech_blit_image_asm );
    ...
    if ( _source_count > 0 ) {
        ...
        vtech_load_image_address_to_register( _environment, NULL, &resource, _sequence, _frame, _frame_size, _frame_count );
    } else {
        outline0( "LD HL, 0" );
    }
...
void vtech_wait_vbl( Environment * _environment, char * _raster_line ) {

    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( vbl, src_hw_vtech_vbl_asm);
...
Variable * vtech_new_image( Environment * _environment, int _width, int _height, int _mode ) {

    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );

    int size = vtech_image_size( _environment, _width, _height, _mode );
...
Variable * vtech_new_images( Environment * _environment, int _frames, int _width, int _height, int _mode ) {

    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );

    int size = calculate_images_size( _environment, _frames, _width, _height, _mode );
    int frameSize = vtech_image_size( _environment, _width, _height, _mode );
...
Variable * vtech_new_sequence( Environment * _environment, int _sequences, int _frames, int _width, int _height, int _mode ) {
...
void vtech_get_image( Environment * _environment, char * _image, char * _x, char * _y, char * _frame, char * _sequence, int _frame_size, int _frame_count, int _palette ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( getimage, src_hw_vtech_get_image_asm );

    MAKE_LABEL

    vtech_load_image_address_to_hl( _environment, _image, _sequence, _frame, _frame_size, _frame_count );
...
void vtech_scroll( Environment * _environment, int _dx, int _dy ) {

    deploy( vic2vars, src_hw_vtech_vars_asm);
    deploy( scroll, src_hw_vtech_scroll_asm);
    deploy( textHScrollLine, src_hw_vtech_hscroll_line_asm );
    deploy( textHScrollScreen, src_hw_vtech_hscroll_screen_asm );
    deploy_preferred( vScrollTextDown, src_hw_vtech_vscroll_text_down_asm );
    deploy_preferred( vScrollTextUp, src_hw_vtech_vscroll_text_up_asm );
...
void vtech_put_tile( Environment * _environment, char * _tile, char * _x, char * _y ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( tiles, src_hw_vtech_tiles_asm );
...
void vtech_move_tiles( Environment * _environment, char * _tile, char * _x, char * _y ) {
...
void vtech_put_tiles( Environment * _environment, char * _tile, char * _x, char * _y, char *_w, char *_h ) {
...
void vtech_tile_at( Environment * _environment, char * _x, char * _y, char *_result ) {
...
void vtech_use_tileset( Environment * _environment, char * _tileset ) {
...
Variable * vtech_get_raster_line( Environment * _environment ) {
...
void vtech_move_memory_video( Environment * _environment, char * _from, char * _to, char * _size ) {

}

void vtech_move_video_memory( Environment * _environment, char * _from, char * _to, char * _size ) {

}

void vtech_colors_vars( Environment * _environment, char * _foreground_color, char * _background_color ) {

}

void vtech_slice_image_copy( Environment * _environment, char * _image,  char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _destination ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( duff, src_hw_z80_duff_asm );
    deploy( sliceimagecopy, src_hw_vtech_slice_image_copy_asm );
    ...
    resource.type = VT_IMAGE;
    vtech_load_image_address_to_register( _environment, "HL", &resource, _sequence, _frame, _frame_size, _frame_count );
...
void vtech_slice_image_extract( Environment * _environment, char * _image,  char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _destination ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( duff, src_hw_z80_duff_asm );
    deploy( sliceimageextract, src_hw_vtech_slice_image_extract_asm );
...
int vtech_palette_extract( Environment * _environment, char * _data, int _width, int _height, int _depth, int _flags, RGBi * _palette ) {
...
void vtech_calculate_sequence_frame_offset( Environment * _environment, char * _offset, char * _sequence, char * _frame, int _frame_size, int _frame_count ) {
...
void vtech_flip_image( Environment * _environment, Resource * _image, char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _direction ) {
    ...
    //     vtech_load_image_address_to_register( _environment, NULL, _image, _sequence, _frame, _frame_size, _frame_count );
    //     deploy( flipimagex, src_hw_vtech_flip_image_x_asm );
    ...
    //     deploy( flipimagey, src_hw_vtech_flip_image_y_asm );
...
void vtech_fade( Environment * _environment, char * _ticks ) {

    deploy_preferred( vtechvars, src_hw_vtech_vars_asm);
    deploy( vtechvarsGraphic, src_hw_vtech_vars_graphic_asm );
    deploy( fade, src_hw_vtech_fade_asm );
