...
void cpu6502_bit_inplace_8bit_extended_indirect( Environment * _environment, char * address, char * _position, int * _bit );
...
#define cpu_bit_inplace_8bit_extended( _environment, _value, _position, _bit ) cpu6502_bit_inplace_8bit_extended( _environment, _value, _position, _bit );
