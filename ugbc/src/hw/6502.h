...
void cpu6502_ztoa( Environment * _environment );
void cpu6502_ctoa( Environment * _environment );
...
void cpu6502_compare_16bit_const( Environment * _environment, char *_source, int _destination,  char *_name, int _positive );
...
void cpu6502_math_div2_const_16bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
void cpu6502_math_div2_const_32bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
void cpu6502_math_div2_const_8bit( Environment * _environment, char *_source, int _value, int _signed, char * _remainder );
...
void cpu6502_poke_const( Environment * _environment, char * _address, int _value );
void cpu6502_peekw( Environment * _environment, char * _address, char * _target );
void cpu6502_pokew( Environment * _environment, char * _address, char * _value );
void cpu6502_pokew_const( Environment * _environment, char * _address, int _value );
void cpu6502_peekd( Environment * _environment, char * _address, char * _target );
void cpu6502_poked( Environment * _environment, char * _address, char * _value );
void cpu6502_poked_const( Environment * _environment, char * _address, int _value );
...
void cpu6502_bit_inplace_8bit_extended_indirect( Environment * _environment, char * address, char * _position, char * _bit );
...
#define cpu_nop( _environment ) cpu6502_nop( _environment )
#define cpu_ztoa( _environment ) cpu6502_ztoa( _environment )
#define cpu_ctoa( _environment ) cpu6502_ctoa( _environment )
...
#define cpu_compare_16bit_const( _environment, _source, _destination, _name, _positive ) cpu6502_compare_16bit_const( _environment, _source, _destination, _name, _positive )
...
#define cpu_less_than_and_branch_8bit_const( _environment, _source, _destination, _label, _equal, _signed ) cpu6502_less_than_and_branch_8bit_const( _environment, _source, _destination, _label, _equal, _signed )
...
#define cpu_fill( _environment,  _address, _bytes, _bytes_width,  _pattern  ) cpu6502_fill( _environment,  _address, _bytes, _bytes_width, _pattern  )
...
#define cpu_call_addr( _environment, _address ) cpu6502_call_addr( _environment, _address )
...
#define cpu_and_8bit_const( _environment, _left, _right,  _result ) cpu6502_and_8bit_const( _environment, _left, _right,  _result )
...
#define cpu_math_div2_const_16bit( _environment, _source, _value, _signed, _remainder ) cpu6502_math_div2_const_16bit( _environment, _source, _value, _signed, _remainder  )
#define cpu_math_div2_const_32bit( _environment, _source, _value, _signed, _remainder ) cpu6502_math_div2_const_32bit( _environment, _source, _value, _signed, _remainder  )
#define cpu_math_div2_const_8bit( _environment, _source, _value, _signed, _remainder ) cpu6502_math_div2_const_8bit( _environment, _source, _value, _signed, _remainder  )
...
#define cpu_poke_const( _environment,  _address,  _value  ) cpu6502_poke_const( _environment,  _address,  _value  )
#define cpu_peekw( _environment,  _address,  _target  ) cpu6502_peekw( _environment,  _address,  _target  )
#define cpu_pokew( _environment,  _address,  _value  ) cpu6502_pokew( _environment,  _address,  _value  )
#define cpu_pokew_const( _environment,  _address,  _value  ) cpu6502_pokew_const( _environment,  _address,  _value  )
#define cpu_peekd( _environment,  _address,  _target  ) cpu6502_peekd( _environment,  _address,  _target  )
#define cpu_poked( _environment,  _address,  _value  ) cpu6502_poked( _environment,  _address,  _value  )
#define cpu_poked_const( _environment,  _address,  _value  ) cpu6502_poked_const( _environment,  _address,  _value  )
...
#define cpu_mem_move_direct2_size( _environment, _source, _destination, _size ) cpu6502_mem_move_direct2_size( _environment, _source, _destination, _size )
...
#define cpu_convert_string_into_8bit( _environment, _string, _len, _value ) cpu6502_convert_string_into_8bit( _environment, _string, _len, _value )
...
#define cpu_fill_indirect( _environment, _address, _size, _pattern, _size_size ) cpu6502_fill_indirect( _environment, _address, _size,  _pattern, _size_size )
...
#define cpu_move_8bit_indirect2_16bit( _environment, _value, _offset, _source ) cpu6502_move_8bit_indirect2_16bit( _environment, _value, _offset, _source )
...
#define cpu_bit_inplace_8bit( _environment, _value, _position, _bit ) cpu6502_bit_inplace_8bit( _environment, _value, _position, _bit );
#define cpu_bit_inplace_8bit_extended_indirect( _environment, _address, _position, _bit ) cpu6502_bit_inplace_8bit_extended_indirect( _environment, _address, _position, _bit );
...
#define cpu_dsinit( _environment ) cpu6502_dsinit( _environment )
...
#define cpu_store_8bit_with_offset2( _environment, _destination, _offset, _value ) cpu6502_store_8bit_with_offset2( _environment, _destination, _offset, _value )
