...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
;*                                                                             *
;*                     1 BIT AUDIO SUPPORT FOR TRS-80 COCO3B 3                   *
;*                                                                             *
;*                             by Marco Spedaletti                             *
;*                                                                             *
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *

COCO3BAUDIO1FREQTABLE
...
COCO3BAUDIO1STARTUP
    ; FIRST WE'RE GOING TO SETUP THE COCO3B PIAS FOR ONE-BIT SOUND ONEBIT
...
COCO3BAUDIO1BELLBITON
    ...
    LDX	TONE
COCO3BAUDIO1BELLLOOPON
    LEAY -1, Y
    BEQ COCO3BAUDIOBELLEND
    LEAX -1, X
    BNE	COCO3BAUDIO1BELLLOOPON

    ; SO NOT WE'VE PLAYED THE NOISE FOR A WHILE LET'S CREATE AN EQUAL SILENCE

COCO3BAUDIO1BELLBITOFF
    LDA	PIA1BD
    ANDA #%11111101
    STA	PIA1BD
    ...
    LDX	TONE
COCO3BAUDIO1BELLLOOPOFF
    LEAY -1, Y
    BEQ COCO3BAUDIOBELLEND
    LEAX -1,X
    BNE	COCO3BAUDIO1BELLLOOPOFF
...
COCO3BAUDIO1BOOMBITON
    ...
    LDX	TONE
COCO3BAUDIO1BOOMLOOPON
    LEAY -1, Y
    BEQ COCO3BAUDIO1BOOMEND
    LEAX -1, X
    BNE	COCO3BAUDIO1BOOMLOOPON
...
COCO3BAUDIO1BOOMBITOFF
    ...
    LDX	TONE
COCO3BAUDIO1BOOMLOOPOFF
    LEAY -1, Y
    BEQ COCO3BAUDIO1BOOMEND
    LEAX -1,X
    BNE	COCO3BAUDIO1BOOMLOOPOFF
