...
TEXTATBITMAPMODEGOFORCE3:
    ...
    STA TEXTATBITMAPMODEGO8HIB, X
    ORA #$00
    LDA TEXTATBITMAPMODEGO8HIB, X

    LDX #0
    LDA TEXTATBMSP0LOLOA, X
    STA TEXTATBMSP0LOLOB, X
    INX
    LDA TEXTATBMSP0LOLOA, X
    STA TEXTATBMSP0LOLOB, X
    INX
    ...
    STA TEXTATBMSP0LOLOB, X
    ORA #$00
    LDA TEXTATBMSP0LOLOB, X

    LDX #0
    LDA TEXTATBMSP0HIHIA, X
    STA TEXTATBMSP0HIHIB, X
    INX
    LDA TEXTATBMSP0HIHIA, X
    STA TEXTATBMSP0HIHIB, X
    INX
