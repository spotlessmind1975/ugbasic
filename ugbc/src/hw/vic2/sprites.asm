...
SPRITEPRIORITY:
    ...
    TYA
    AND #$F0
    BEQ SPRITEPRIORITYSINGLEY
    JMP SPRITEPRIORITYMULTIPLEY
SPRITEPRIORITYSINGLEY:
    LDA MATHPTR0
    BEQ SPRITEPRIORITYSINGLEYRESET
    LDA #<BITMASK
    STA TMPPTR
    LDA #>BITMASK
    STA TMPPTR+1
    ...
    ORA (TMPPTR),Y
    STA $D01B
    JMP SPRITEPRIORITYSINGLEYDONE
SPRITEPRIORITYSINGLEYRESET:
    LDA #<BITMASKN
    STA TMPPTR
    LDA #>BITMASKN
    STA TMPPTR+1
    ...
    AND (TMPPTR),Y
    STA $D01B
SPRITEPRIORITYSINGLEYDONE:
    RTS
SPRITEPRIORITYMULTIPLEY:
    JSR SPRITEDECODEY
    LDY MATHPTR4
SPRITEPRIORITYMULTIPLEL1Y:
    JSR SPRITEPRIORITYSINGLEY
    INY
    CPY MATHPTR5
    BNE SPRITEPRIORITYMULTIPLEL1Y
    RTS
