...
CPUMATHDIV16BITTO16BIT_fast
    ...
    CMPX  #2
    BEQ   CPUMATHDIV16BITTO16BIT_fast2
    BLO   CPUMATHDIV16BITTO16BIT_fast1

    CMPX  #4
    BEQ   CPUMATHDIV16BITTO16BIT_fast4
    BLO   CPUMATHDIV16BITTO16BIT_fast3

    CMPX  #8
    BEQ   CPUMATHDIV16BITTO16BIT_fast8
    BLO   CPUMATHDIV16BITTO16BIT_notfast
    
    CMPX  #16
    BEQ   CPUMATHDIV16BITTO16BIT_fast16
    BLO   CPUMATHDIV16BITTO16BIT_notfast
    
    CMPX  #32
    BEQ   CPUMATHDIV16BITTO16BIT_fast32
    BLO   CPUMATHDIV16BITTO16BIT_notfast
    
    CMPX  #64
    BEQ   CPUMATHDIV16BITTO16BIT_fast64
    BLO   CPUMATHDIV16BITTO16BIT_notfast
    
    CMPX  #128
    BEQ   CPUMATHDIV16BITTO16BIT_fast128

CPUMATHDIV16BITTO16BIT_fast3
CPUMATHDIV16BITTO16BIT_notfast
    STD   ,S
    BRA   CPUMATHDIV16BITTO16BIT0  
    
CPUMATHDIV16BITTO16BIT_fast128    
    LSRA
    RORB
CPUMATHDIV16BITTO16BIT_fast64    
    LSRA
    RORB
...
CPUMATHDIV16BITTO16BIT_fast2    
    LSRA
    RORB
CPUMATHDIV16BITTO16BIT_fast1
    PULS  X,PC
    
CPUMATHDIV16BITTO16BIT_fast256
    LDX   #0
    ABX
    TFR   A,B
    CLRA
...
CPUMATHDIV16BITTO16BIT
    CMPX  #256
    BLO   CPUMATHDIV16BITTO16BIT_fast
    BEQ   CPUMATHDIV16BITTO16BIT_fast256
