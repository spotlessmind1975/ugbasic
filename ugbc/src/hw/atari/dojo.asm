...
DOJOSERIALPUTREQUEST:
    ...
    LDA MATHPTR2
    BEQ DOJOSERIALPUTREQUESTNOPAYLOAD
    LDA TMPPTR2
    STA TMPPTR
    LDA TMPPTR2+1
    STA TMPPTR+1
...
DOJOSERIALGETRESPONSEPAYLOADW:
    LDX DOJOPACKET_RSIZE+1
    CPX #0
    BEQ DOJOSERIALGETRESPONSEPAYLOAD
    LDA TMPPTR2
    STA TMPPTR
    LDA TMPPTR2+1
    STA TMPPTR+1
    ...
    STA MATHPTR0
    JSR SERIALREAD
    DEC DOJOPACKET_RSIZE+1
    JMP DOJOSERIALGETRESPONSEPAYLOADW
