...
FUJINETSETCHANNELMODESIO:
    ...
    JSR FUJINETGETSTATUSSIO
    LDA FUJINETERRORCODE
    BEQ FUJINETSETCHANNELMODESIOERR
    LDA #1
FUJINETSETCHANNELMODESIOERR:
    RTS
...
FUJINETPARSEJSONSIO:
    ...
    JSR FUJINETGETSTATUSSIO
    LDA FUJINETERRORCODE
    BEQ FUJINETPARSEJSONSIOERR
    LDA #1
FUJINETPARSEJSONSIOERR:
    RTS
...
FUJINETSETJSONQUERYSIO:
    ...
    JSR FUJINETGETSTATUSSIO
    LDA FUJINETERRORCODE
    BEQ FUJINETSETJSONQUERYSIOERR
    LDA #1
FUJINETSETJSONQUERYSIOERR:
    RTS
...
FUJINETPASSWORDSIO:
    ...
    JSR FUJINETGETSTATUSSIO
    LDA FUJINETERRORCODE
    BEQ FUJINETPASSWORDSIOERR
    LDA #1
FUJINETPASSWORDSIOERR:
    RTS
