...
#if defined(__d32b__) || defined(__d64b__) || defined(__cocob__)
...
void c6847b_bitmap_at( Environment * _environment, char * _address ) {
    ...
    outline0("JSR C6847bVIDEOSTARTATB" );
...
void c6847b_textmap_at( Environment * _environment, char * _address ) {
    ...
    outline1("LDD %s", _address);
    outline0("JSR C6847bVIDEOSTARTATT" );
...
void c6847b_cls( Environment * _environment ) {
    ...
    if ( _environment->currentMode < 7 ) {
        deploy( clsText, src_hw_6847b_cls_text_asm );
        outline0("JSR CLST");
    } else {
...
void c6847b_cls_box( Environment * _environment, char * _x1, char * _y1, char * _w, char * _h ) {
    ...
    if ( _environment->currentMode < 7 ) {
        ...
        deploy( clsBox, src_hw_6847b_cls_box_asm );
        outline1("LDD %s", _x1 );
        outline0("STD <IMAGEX" );
        outline1("LDD %s", _y1 );
        outline0("STD <IMAGEY"  );
...
void c6847b_scroll_text( Environment * _environment, int _direction, int _overlap ) {
    ...
    if ( _environment->currentMode < 7 ) {
        deploy_preferred( vScrollText, src_hw_6847b_vscroll_text_asm );
        ...
        deploy_preferred( vScroll, src_hw_6847b_vscroll_graphic_asm );
        outline1("LDA #$%2.2x", ( _direction & 0xff ) );
        outline0("STA <DIRECTION" );
        outline1("LDA #$%2.2x", ( _overlap & 0xff ) );
        outline0("STA <PORT" );
...
void c6847b_text( Environment * _environment, char * _text, char * _text_size, int _raw ) {
    ...
    if ( _raw ) {
        if ( _environment->currentMode < 7 ) {
            deploy( clsText, src_hw_6847b_cls_text_asm );
            deploy_preferred( vScrollText, src_hw_6847b_vscroll_text_asm );
            deploy( textEncodedAtTextRaw, src_hw_6847b_text_at_text_raw_asm );
            outline0("JSR TEXTATTILEMODERAW");
        } else {
            deploy( clsGraphic, src_hw_6847b_cls_graphic_asm );
            deploy( vScroll, src_hw_6847b_vscroll_graphic_asm );
            deploy( textEncodedAtGraphicRaw, src_hw_6847b_text_at_graphic_raw_asm );
        ...
        if ( _environment->currentMode < 7 ) {
            deploy( clsText, src_hw_6847b_cls_text_asm );
            deploy_preferred( vScrollText, src_hw_6847b_vscroll_text_asm );
            deploy( textEncodedAtText, src_hw_6847b_text_at_text_asm );
            outline0("JSR TEXTATTILEMODE");
        } else {
            deploy( clsGraphic, src_hw_6847b_cls_graphic_asm );
            deploy( vScroll, src_hw_6847b_vscroll_graphic_asm );
            deploy( textEncodedAtGraphic, src_hw_6847b_text_at_graphic_asm );
...
void c6847b_hscroll_line( Environment * _environment, int _direction, int _overlap ) {
    ...
    deploy_preferred( textHScroll, src_hw_6847b_hscroll_text_asm );
...
void c6847b_cline( Environment * _environment, char * _characters ) {
    ...
    if ( _environment->currentMode < 7 ) {
        deploy( textCline, src_hw_6847b_cline_text_asm );
        outline0("JSR CLINE");
    } else {
        deploy( textClineGraphic, src_hw_6847b_cline_graphic_asm );
        outline0("JSR CLINEG");
    }
...
static Variable * c6847b_image_converter_bitmap_mode_standard( Environment * _environment, char * _source, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _transparent_color, int _flags ) {
    ...
    int bufferSize = c6847b_image_size( _environment, _frame_width, _frame_height, BITMAP_MODE_RESOLUTION1, (_transparent_color & 0x0f0000 ) ? 1 : 0 );
    // printf("bufferSize = %d\n", bufferSize );
...
static Variable * c6847b_image_converter_multicolor_mode_standard( Environment * _environment, char * _source, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _transparent_color, int _flags ) {
    ...
    int bufferSize = c6847b_image_size( _environment, _frame_width, _frame_height, BITMAP_MODE_COLOR1, 0 );
...
Variable * c6847b_image_converter( Environment * _environment, char * _data, int _width, int _height, int _depth, int _offset_x, int _offset_y, int _frame_width, int _frame_height, int _mode, int _transparent_color, int _flags ) {
    ...
    switch( _mode ) {
        ...
        case BITMAP_MODE_COLOR6:            // Color Graphics 6	128 × 192	4	6144
            ...
            return c6847b_image_converter_multicolor_mode_standard( _environment, _data, _width, _height, _depth, _offset_x, _offset_y, _frame_width, _frame_height, _transparent_color, _flags );
        ...
        case BITMAP_MODE_RESOLUTION6:       // Resolution Graphics 6	256 × 192	1 + Black	6144            break;
            ...
            return c6847b_image_converter_bitmap_mode_standard( _environment, _data, _width, _height, _depth, _offset_x, _offset_y, _frame_width, _frame_height, _transparent_color, _flags );

    }

    WARNING_IMAGE_CONVERTER_UNSUPPORTED_MODE( _mode );

    return c6847b_new_image( _environment, 8, 8, BITMAP_MODE_RESOLUTION6 );

}

static void c6847b_load_image_address_to_register( Environment * _environment, char * _register, Resource * _source, char * _sequence, char * _frame, int _frame_size, int _frame_count ) {
...
void c6847b_blit_image( Environment * _environment, char * _sources[], int _source_count, char * _blit, char * _x, char * _y, char * _frame, char * _sequence, int _frame_size, int _frame_count, int _flags ) {
    ...
    if ( _source_count > 0 ) {
        ...
        c6847b_load_image_address_to_register( _environment, "BLITTMPPTR", &resource, _sequence, _frame, _frame_size, _frame_count );
    } else {
        outline0( "LDY #0" );
    ...
    if ( _source_count > 1 ) {
        ...
        resource.isAddress = 0;
        resource.type = VT_IMAGE;
        c6847b_load_image_address_to_register( _environment, "BLITTMPPTR2", &resource, _sequence, _frame, _frame_size, _frame_count );
    } else {
        outline0( "LDY #0" );
...
Variable * c6847b_new_image( Environment * _environment, int _width, int _height, int _mode ) {
    ...
    int size = c6847b_image_size( _environment, _width, _height, _mode, 0 );
...
Variable * c6847b_new_images( Environment * _environment, int _frames, int _width, int _height, int _mode ) {
    ...
    int frameSize = c6847b_image_size( _environment, _width, _height, _mode, 0 );
...
void c6847b_flip_image( Environment * _environment, Resource * _image, char * _frame, char * _sequence, int _frame_size, int _frame_count, char * _direction ) {
    ...
    if ( strcmp( _direction, "#FLIPIMAGEDIRECTION0001" ) == 0 || strcmp( _direction, "#FLIPIMAGEDIRECTION0003" ) == 0 ) {
        ...
        deploy( flipimagex, src_hw_6847b_flip_image_x_asm );
    ...
    if ( strcmp( _direction, "#FLIPIMAGEDIRECTION0002" ) == 0 || strcmp( _direction, "#FLIPIMAGEDIRECTION0003" ) == 0 ) {
        c6847b_load_image_address_to_register( _environment, "TMPPTR", _image, _sequence, _frame, _frame_size, _frame_count );
        deploy( flipimagey, src_hw_6847b_flip_image_y_asm );
...
void c6847b_screen( Environment * _environment, char * _x, char * _y, char * _c ) {
    ...
    deploy( screen, src_hw_6847b_screen_asm);
