...
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
;*                                                                             *
;*                     1 BIT AUDIO SUPPORT FOR TRS-80 COCOB 1/2                 *
;*                                                                             *
;*                             by Marco Spedaletti                             *
;*                                                                             *
;* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *

COCOBAUDIO1FREQTABLE
...
COCOBAUDIO1STARTUP
    ; FIRST WE'RE GOING TO SETUP THE COCOB PIAS FOR ONE-BIT SOUND ONEBIT
...
COCOBAUDIO1BELLBITON
    ...
    LDX	TONE
COCOBAUDIO1BELLLOOPON
    LEAY -1, Y
    BEQ COCOBAUDIOBELLEND
    LEAX -1, X
    BNE	COCOBAUDIO1BELLLOOPON

    ; SO NOT WE'VE PLAYED THE NOISE FOR A WHILE LET'S CREATE AN EQUAL SILENCE

COCOBAUDIO1BELLBITOFF
    LDA	PIA1BD
    ANDA #%11111101
    STA	PIA1BD
    ...
    LDX	TONE
COCOBAUDIO1BELLLOOPOFF
    LEAY -1, Y
    BEQ COCOBAUDIOBELLEND
    LEAX -1,X
    BNE	COCOBAUDIO1BELLLOOPOFF
...
COCOBAUDIO1BOOMBITON
    ...
    LDX	TONE
COCOBAUDIO1BOOMLOOPON
    LEAY -1, Y
    BEQ COCOBAUDIO1BOOMEND
    LEAX -1, X
    BNE	COCOBAUDIO1BOOMLOOPON
...
COCOBAUDIO1BOOMBITOFF
    ...
    LDX	TONE
COCOBAUDIO1BOOMLOOPOFF
    LEAY -1, Y
    BEQ COCOBAUDIO1BOOMEND
    LEAX -1,X
    BNE	COCOBAUDIO1BOOMLOOPOFF
