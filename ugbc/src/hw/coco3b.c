...
void coco3b_color_border( Environment * _environment, char * _color ) {

}

void coco3b_vscroll( Environment * _environment, int _displacement ) {

}

void coco3b_text_at( Environment * _environment, char * _text, char * _text_size, char * _pen, char * _paper ) {

}

void coco3b_cls( Environment * _environment, char * _pen, char * _paper ) {

}

void coco3b_initialization( Environment * _environment ) {

}

int coco3b_screen_mode_enable( Environment * _environment, ScreenMode * _screen_mode ) {
    
}

void coco3b_bitmap_enable( Environment * _environment, int _width, int _height, int _colors ) {

}

void coco3b_tilemap_enable( Environment * _environment, int _width, int _height, int _colors, int _tile_width, int _tile_height ) {
    
}

void coco3b_back( Environment * _environment ) {
...
void coco3b_busy_wait( Environment * _environment, char * _timing ) {
    ...
    outline0("LDX COCO3BTIMER");
    outline0("LEAX D, X");
    outhead1("%sfirst", label );
    outline0("CMPX COCO3BTIMER");
...
void coco3b_dload( Environment * _environment, char * _filename, char * _offset, char * _address, char * _size ) {
    ...
    deploy_preferred( dcommon, src_hw_coco3b_dcommon_asm);
    deploy_preferred( dload, src_hw_coco3b_dload_asm);
...
void coco3b_dsave( Environment * _environment, char * _filename, char * _offset, char * _address, char * _size ) {
    ...
    deploy_preferred( dcommon, src_hw_coco3b_dcommon_asm);
    deploy_preferred( dsave, src_hw_coco3b_dsave_asm);
...
void coco3b_serial_read( Environment * _environment, char * _address, char * _size ) {
    ...
    deploy( serial, src_hw_coco3b_serial_asm);
...
void coco3b_fujinet_set_device( Environment * _environment, int _device_id ) {
    ...
    deploy( serial, src_hw_coco3b_serial_asm);
    deploy( fujinet, src_hw_coco3b_fujinet_asm);
...
void coco3b_dojo_serial_get_response0( Environment * _environment, char * _status ) {
    ...
    deploy( serial, src_hw_coco3b_serial_asm);
    deploy( dojo, src_hw_coco3b_dojo_asm);
...
void coco3b_dojo_serial_get_response_size( Environment * _environment, char * _status, char * _size ) {
...
void coco3b_dojo_fujinet_get_response0( Environment * _environment, char * _status ) {
    ...
    deploy( serial, src_hw_coco3b_serial_asm);
    deploy( fujinet, src_hw_coco3b_fujinet_asm);
    deploy( dojo_fujinet, src_hw_coco3b_dojo_fujinet_asm);
...
void coco3b_dojo_fujinet_get_response_size( Environment * _environment, char * _status, char * _size ) {
