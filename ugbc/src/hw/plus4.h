...
void plus4_scancode( Environment * _environment, char * _scacode );
void plus4_asciicode( Environment * _environment, char * _asciicode );
...
void plus4_dojo_login( Environment * _environment, char * _name, char * _name_size, char * _password, char * _size, char * _unique_id );
...
void plus4_dojo_find_port( Environment * _environment, char * _session_id, char * _username, char * _size, char * _application, char * _application_size, char * _port_id );
