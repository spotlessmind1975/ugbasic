...
SN76489PROGDUR:
    SRL A
    JP C, SN76489PROGDUR0X
    CALL SN76489PROGDUR0
SN76489PROGDUR0X:
    SRL A
    JP C, SN76489PROGDUR1X
    CALL SN76489PROGDUR1
SN76489PROGDUR1X:
    SRL A
    JP C, SN76489PROGDUR2X
...
SN76489WAITDUR:
    SRL A
    JP C, SN76489WAITDUR0X
    CALL SN76489WAITDUR0
SN76489WAITDUR0X:
    SRL A
    JP C, SN76489WAITDUR1X
    CALL SN76489WAITDUR1
SN76489WAITDUR1X:
    SRL A
    JP C, SN76489WAITDUR2X
...
SN76489WAITDUR0:
    ...
    LD A, E
    OR D
    JR NZ, SN76489WAITDUR0X
    RET
SN76489WAITDUR1:
    LD DE, (SN76489TIMER+2)
    LD A, E
    OR D
    JR NZ, SN76489WAITDUR1X
    RET
SN76489WAITDUR2:
    LD DE, (SN76489TIMER+4)
    LD A, E
    OR D
    JR NZ, SN76489WAITDUR2X
    RET
