#ifndef __UGBC_COCOB__
#define __UGBC_COCOB__
...
void cocob_dojo_serial_get_response_size( Environment * _environment, char * _status, char * _data );
...
void cocob_dojo_fujinet_get_response_size( Environment * _environment, char * _status, char * _data );
