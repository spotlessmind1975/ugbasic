...
VIC1SETDURATION:
    LSR
    BCC VIC1SETDURATION0X
    JSR VIC1SETDURATION0
VIC1SETDURATION0X:
    LSR
    BCC VIC1SETDURATION1X
    JSR VIC1SETDURATION1
VIC1SETDURATION1X:
    LSR
    BCC VIC1SETDURATION2X
    JSR VIC1SETDURATION2
VIC1SETDURATION2X:
    RTS
...
VIC1WAITDURATION:
    LSR
    BCC VIC1WAITDURATION0X
    JSR VIC1WAITDURATION0
VIC1WAITDURATION0X:
    LSR
    BCC VIC1WAITDURATION1X
    JSR VIC1WAITDURATION1
VIC1WAITDURATION1X:
    LSR
    BCC VIC1WAITDURATION2X
    JSR VIC1WAITDURATION2
VIC1WAITDURATION2X:
    RTS

VIC1WAITDURATION0:
    LDX VIC1TIMER
    BNE VIC1WAITDURATION0
    RTS

VIC1WAITDURATION1:
    LDX VIC1TIMER+1
    BNE VIC1WAITDURATION1
    RTS

VIC1WAITDURATION2:
    LDX VIC1TIMER+2
    BNE VIC1WAITDURATION2
    RTS
...
MUSICPLAYERRESET:
    ...
    LDA #$1
    STA VIC1MUSICREADY
    LDA VIC1TMPPTR_BACKUP
    STA VIC1TMPPTR
    LDA VIC1TMPPTR_BACKUP+1
    STA VIC1TMPPTR+1
    LDA VIC1LASTBLOCK_BACKUP
    STA VIC1LASTBLOCK
    LDA VIC1BLOCKS_BACKUP
    STA VIC1BLOCKS
