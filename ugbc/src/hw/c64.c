...
void c64_dojo_ready( Environment * _environment, char * _value ) {
    ...
    deploy( dojo, src_hw_c64_dojo_asm);
...
void c64_dojo_login( Environment * _environment, char * _username, char * _size, char * _password, char * _password_size, char * _session_id ) {

    deploy( dojo, src_hw_c64_dojo_asm);

    outline1("LDA %s", _session_id );
    outline0("STA DOJOCURRENTKAPTR" );
    outline1("LDA %s", address_displacement( _environment, _session_id, "1" ) );
...
void c64_dojo_success( Environment * _environment, char * _id, char * _result ) {
    ...
    outline1("LDA %s", _id );
    outline0("STA TMPPTR" );
    outline1("LDA %s", address_displacement( _environment, _id, "1" ) );
    outline0("STA TMPPTR+1" );
...
void c64_dojo_create_port( Environment * _environment, char * _session_id, char * _application, char * _size, char * _port_id ) {
    ...
    outline0("STA DOJOCURRENTKAPTR" );
    outline1("LDA %s", address_displacement( _environment, _port_id, "1" ) );
    outline0("STA DOJOCURRENTKAPTR+1" );
...
void c64_dojo_find_port( Environment * _environment, char * _session_id, char * _username, char * _size, char * _application, char * _application_size, char * _public_id ) {
    ...
    outline1("LDA %s", address_displacement( _environment, _public_id, "1" ) );
