...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    INK = 394,                     /* INK  */
    TIMER = 395,                   /* TIMER  */
    MILLISECOND = 396,             /* MILLISECOND  */
    MILLISECONDS = 397,            /* MILLISECONDS  */
    TICKS = 398,                   /* TICKS  */
    BLACK = 399,                   /* BLACK  */
    WHITE = 400,                   /* WHITE  */
    RED = 401,                     /* RED  */
    ...
    MAGENTA = 413,                 /* MAGENTA  */
    PURPLE = 414,                  /* PURPLE  */
    LAVENDER = 415,                /* LAVENDER  */
    GOLD = 416,                    /* GOLD  */
    TURQUOISE = 417,               /* TURQUOISE  */
    TAN = 418,                     /* TAN  */
    PINK = 419,                    /* PINK  */
    PEACH = 420,                   /* PEACH  */
    OLIVE = 421,                   /* OLIVE  */
    Identifier = 422,              /* Identifier  */
    String = 423,                  /* String  */
    Integer = 424                  /* Integer  */
  };
...
#line 238 "src-generated/ugbc.tab.h"
